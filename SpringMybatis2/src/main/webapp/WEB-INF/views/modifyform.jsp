<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <%@page import="com.spring.springmybatis.MemberVO" %>
...
<!-- <table border=1 width=400> -->
	<tr>
		<td colspan="2" align=center>
			...
			<tr><td>아이디: </td><td> <%=memberList.getId() %>  </td><!-- 아이디는 고정값이어야 -->
			<input type="hidden" name="id" value= <%=memberList.getId() %> ></tr>	
					<!--<tr><td>아이디: </td><td> <%=vo.getId() %>  </td>	-->	
			...
			<td><input type="password"  name="password"
			 value= <%=memberList.getPassword() %>></td>
			 </tr> 	
			...
			<tr>
			<td>이름: </td>
			<td><input type="text" name="name"  value= <%=memberList.getName() %>></td>
			</tr>
			...
			<tr><td>나이:</td>
			<td><input type="text" name="age"  value= <%=memberList.getAge() %>></td>
			</tr>
			...
			<tr>
				...
				<tr>
				<td>이메일주소:</td>
				<td> <input type="text" name="email" size=30  value= <%=memberList.getEmail() %>></td>
				</tr> 
